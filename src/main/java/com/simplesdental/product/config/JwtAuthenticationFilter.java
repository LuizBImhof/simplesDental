...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Bean
    public JwtAuthenticationFilter jwtAuthenticationFilter(JwtUtil jwtUtil, AuthenticationManager authManager, UserRepository userRepository) {
        return new JwtAuthenticationFilter(jwtUtil, authManager, userRepository);
    }
}
